...
feature I18n.t('post.edit') do
  ...
  scenario 'Non-authenticated user try to edit post' do
    ...
    expect(page).to_not have_link I18n.t('post.edit')
  end
  ...
  describe 'Authenticated user' do
    ...
    scenario 'sees link to edit post' do
      expect(page).to have_link(I18n.t('post.edit'))
    end

    scenario 'try to edit post with invalid data' do
      click_on I18n.t('post.edit')

      fill_in 'Title', with: nil
      fill_in 'Body', with: nil
      click_on I18n.t('post.submit')
  ...
  scenario 'Authenticated user try to edit other user post' do
    ...
    expect(page).to_not have_content I18n.t('post.edit')
  end
end
